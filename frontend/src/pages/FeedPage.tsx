...
interface FeedPageProps {
  title: string
  description: string
  /** react-query cache key prefix; kept distinct per page so Top/Latest don't share pages. */
  queryKeyPrefix: string
  sort: 'relevance' | 'recent'
}

/** Shared infinite-scroll feed used by the Top and Latest pages (differ only in sort/copy). */
export function FeedPage({ title, description, queryKeyPrefix, sort }: FeedPageProps) {
  ...
  const {
    ...
    queryKey: [queryKeyPrefix, { topic: topicParam }],
